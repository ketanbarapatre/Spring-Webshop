...
public class ProductController
{
	...
	public ModelAndView submitCreateProductForm(@Valid Product product, BindingResult bindingResult,
			RedirectAttributes redirectAttributes) throws CouldNotAddProductException
	{
		...
		} else
		{
			...
			boolean result = ecommerceService.checkProduct(product.getProductName(), product.getReferenceNumber(),
					product.getPrice(), product.getBrand());
			System.out.println(result);
			if (!result)
			{
				ecommerceService.addProduct(product.getProductName(), product.getReferenceNumber(), product.getPrice(),
						product.getBrand(), product.getDescription(), product.getGenre(), product.getState());
	...
	public ModelAndView submitProductForm(@Valid Product product, BindingResult bindingResult,
	...
	public ModelAndView updateProductPost(Product product, BindingResult bindingResult,
	...
	public ModelAndView displayUpdateProduct(@PathVariable String productId, Model model) throws ProductNotFoundException
	{
	...
	public ModelAndView updateProduct(@PathVariable String productId, @Valid Product productForm,
			BindingResult bindingResult, RedirectAttributes redirectAttributes) throws CouldNotUpdateProductException, ProductNotFoundException
	{
		ecommerceService.updateProduct(productForm.getProductName(), productForm.getReferenceNumber(),
				productForm.getPrice(), productForm.getBrand(), productForm.getDescription(), productForm.getGenre(),
				productForm.getState());
