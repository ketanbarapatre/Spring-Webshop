...
public class UserController
{
	...
	public ModelAndView submitCreateUserForm(@Valid User user, BindingResult bindingResult,
			RedirectAttributes redirectAttributes) throws UserAlreadyExistsException
	{
		...
		} else
		{
			...
			boolean result = ecommerceService.checkUser(user.getFirstName(), user.getLastName(), user.getCo(),
					user.getStreet(), user.getPostal(), user.getCity(), user.getCountry(), user.getPhone(),
					user.getGender(), user.getEmail(), user.getPassword());
			if (!result)
			{

				ecommerceService.addUser(user.getFirstName(), user.getLastName(), user.getCo(), user.getStreet(),
						user.getPostal(), user.getCity(), user.getCountry(), user.getPhone(), user.getGender(),
	...
	public ModelAndView submitDisplayUserForm(@Valid User user, BindingResult bindingResult,
	...
	public ModelAndView updateUser(@PathVariable String userId, @Valid User user, BindingResult bindingResult,
			RedirectAttributes redirectAttributes)
	{
		ecommerceService
				.updateUser(user.getFirstName(), user.getLastName(), user.getCo(), user.getStreet(), user.getPostal(),
						user.getCity(), user.getCountry(), user.getPhone(), user.getGender(), user.getEmail());
