...
public class AdminController
{
	...
	public ModelAndView submitCreateProductForm(@Valid Admin admin, BindingResult bindingResult,
			RedirectAttributes redirectAttributes) throws CouldNotCreateAdminException
	{
		...
		} else
		{
			...
			boolean result = ecommerceService.checkAdmin(admin.getEmail(), admin.getFirstName(), admin.getLastName(),
					admin.getPassword());
			if (result)
			{
				return new ModelAndView("createAdmin");
			...
			{
				ecommerceService.addAdmin(admin.getEmail(), admin.getFirstName(), admin.getLastName(),
						admin.getPassword());
