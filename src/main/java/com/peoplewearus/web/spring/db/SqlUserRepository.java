...
public class SqlUserRepository implements UserRepository
{
	...
	public Collection<User> getAllUsers()
	{
		...
		try
		{
			PreparedStatement getAllUsersByStatement = con.prepareStatement(GET_ALL_USERS);
			...
			throws UserAlreadyExistsException
	{
		...
		if (firstName == null || firstName.trim() == "" || lastName == null || lastName.trim() == "" || street == null
				...
				|| country == null || country.trim() == "" || phone == null || phone.trim() == "" || email == null
				|| email.trim() == "" || password == null || password.trim() == "")
		{
			return true;
	...
	private User extractUser(final ResultSet resultSet) throws SQLException
	{
		...
		return new User(resultSet.getString("user_table.firstName"), resultSet.getString("user_table.lastName"),
				resultSet.getString("user_table.co"), resultSet.getString("user_table.street"),
				resultSet.getString("user_table.postal"), resultSet.getString("user_table.city"),
