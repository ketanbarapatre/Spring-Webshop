...
public class SqlAdminRepository implements AdminRepository
{
	...
	public void addAdmin(String firstName, String lastName, String email, String password) throws CouldNotCreateAdminException
	{
		...
		} catch (SQLException e)
		{
			...
			{
				throw new CouldNotCreateAdminException();
			}
	...
	public Collection<Admin> getAllAdmins()
	{
		...
		try
		{
			PreparedStatement getAllAdminsByStatement = con.prepareStatement(GET_ALL_ADMINS);
	...
	public boolean checkAdmin(String email, String password, String firstName, String lastName)
	{
		...
		if (email == null || email.trim() == "" || password == null || password.trim() == "" || firstName == null
				|| firstName.trim() == "" || lastName == null || lastName.trim() == "")
		{
	...
	private Admin extractAdmin(final ResultSet resultSet) throws SQLException
	{
		...
		return new Admin(resultSet.getString("admin_table.firstName"), resultSet.getString("admin_table.lastName"),
				resultSet.getString("admin_table.email"), resultSet.getString("admin_table.password"));
	}
